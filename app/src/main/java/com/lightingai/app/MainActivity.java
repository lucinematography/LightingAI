...
public class MainActivity extends Activity {
    ...
    private void installCatalogView() {
        if (webView == null) return;
        String js = "(function(){" +
            "window.catalogFixtures=[];window.catalogAccessories=[];window.equipment=[];window.catalogArmed=null;window.catalogOpen={aputure:true,aputureFixtures:false,aputureAccessories:false,arri:false,arriFixtures:false,arriAccessories:false};" +
            ...
            "function saveOpen(){var d=document.querySelectorAll('#equipmentList details[data-open-key]');d.forEach(function(x){window.catalogOpen[x.getAttribute('data-open-key')]=x.open;});}" +
            ...
            "h+='<details data-open-key=\\\"aputure\\\" class=\\\"card\\\"'+openAttr('aputure')+'><summary style=\\\"font-weight:900;font-size:21px;cursor:pointer\\\"><span style=\\\"display:inline-block;border:1px solid currentColor;border-radius:6px;padding:3px 8px;margin-right:8px;font-size:13px\\\">APUTURE</span> Aputure <span class=\\\"muted small\\\">('+(af.length+aa.length)+')</span></summary><div style=\\\"margin-top:12px\\\"><details data-open-key=\\\"aputureFixtures\\\" class=\\\"card\\\"'+openAttr('aputureFixtures')+'><summary style=\\\"font-weight:800;font-size:18px;cursor:pointer\\\">'+(sr?'RASVETNA TELA':'FIXTURES')+' ('+af.length+')</summary><div style=\\\"margin-top:12px\\\">'+fixtureRows(af,sr,'#f5c542')+'</div></details><details data-open-key=\\\"aputureAccessories\\\" class=\\\"card\\\"'+openAttr('aputureAccessories')+'><summary style=\\\"font-weight:800;font-size:18px;cursor:pointer\\\">'+(sr?'DODATNA OPREMA':'ACCESSORIES')+' ('+aa.length+')</summary><div style=\\\"margin-top:12px\\\">'+accessoryRows(aa,sr)+'</div></details></div></details>';" +
