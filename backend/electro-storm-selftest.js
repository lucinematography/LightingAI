...
// Protect only Bowens links explicitly present in the verified runtime catalog; shared mount alone is not compatibility evidence.
for(const id of ['aputure-space-light-90','aputure-quick-dome-90','aputure-spotlight-max']) if(!xt26.has(id)) errors.push(`XT26 missing official compatible Bowens accessory ${id}`);
