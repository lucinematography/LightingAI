...
const S3='https://www.litegear.com/wp-content/uploads/2019/06/S2-LiteMat-3-Data-Sheet-1.pdf';
const PRO_HYBRID_HICAP='https://www.litegear.com/product/litedimmer-hybrid-16a-high-capacity/';
...
export const LITEGEAR_LITEMAT_S2_FIXTURES=[
  ...
  fixture('litegear-litemat-s2-2l','LiteMat S2 2L',100,576,1.6,'292 x 1016 x 23 mm',S2L,{
    control:{
      fixtureNative:{
        local:false,dmx512:false,rdm:false,artNet:false,sacn:false,crmx:false,bluetooth:false,wifi:false,
        note:'LiteMat S2 2L head is a passive 12V Hybrid light engine; manufacturer-documented control is provided by the external LiteDimmer Pro Hybrid.'
      },
      controller:{
        model:'LiteDimmer Pro Hybrid',
        connectionToFixture:'3-conductor HyConn / PH3 output path',
      ...
      sourceUrls:[S2L,PRO_HYBRID,PRO_HYBRID_GUIDE,S2_SUPPORT]
    }
  }),
  fixture('litegear-litemat-s2-3','LiteMat S2 3',150,864,2.1,'533 x 775 x 23 mm',S3,{
    control:{
      fixtureNative:{
        local:false,dmx512:false,rdm:false,artNet:false,sacn:false,crmx:false,bluetooth:false,wifi:false,
        note:'LiteMat S2 3 head is a passive 12V Hybrid light engine; its official data sheet specifies the external LiteDimmer Pro Hybrid High Capacity.'
      },
      controller:{
