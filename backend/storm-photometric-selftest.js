...
assert.equal(storm400.nativeBeamAngleDeg, 57, 'STORM 400x native beam changed');
assert.equal(storm400.reflectorBeamAngleDeg, 35, 'STORM 400x included reflector beam changed');
...
assert.equal(storm700.nativeBeamAngleDeg, 58, 'STORM 700x native beam changed');
assert.equal(storm700.reflectorBeamAngleDeg, 35, 'STORM 700x included reflector beam changed');
