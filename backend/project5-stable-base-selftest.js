...
console.log(JSON.stringify({
  ...
  featureSurface: 'Project 5 catalog expansion: add verified De Sisti Soft LED families and accessories without changing Planner layout or existing manufacturer data'
}, null, 2));
