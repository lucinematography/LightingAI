...
const F7_VW_DMX_WIDTHS='https://www.desisti.it/wp-content/uploads/mini-catalog-2024-1.pdf';
...
const F10_VW_DMX_MANUAL = 'https://www.desisti.it/wp-content/uploads/CE-INSTRUCTION-MANUAL-SUPER-LED-FRESNEL-F10-Vari-White.pdf';
...
const verifiedFixedDimmerWidths = (sourceUrl) => [
  {name:'8-bit dimmer',channels:1,verified:true,sourceUrl,controls:[{key:'dimmer',label:'Dimmer',channel:1,type:'percent',min:0,max:100,dmxMin:0,dmxMax:255}]},
  {name:'16-bit dimmer',channels:2,verified:true,sourceUrl}
];
...
export const DESISTI_LED_FRESNEL_FIXTURES = [
  ...
  vw('desisti-super-led-f7-vw','Super LED F7 Vari-White','Super LED F7',160,null,2800,6600,175,F7_VW_SRC,{rainProtectedOption:'IP23',dmxModes:[{name:'Vari-White',channels:3,verified:true,sourceUrl:F7_VW_SRC,controls:[{key:'dimmer',label:'Dimmer',channel:1,type:'percent',min:0,max:100,dmxMin:0,dmxMax:255}]},{name:'Vari-White 16-bit',channels:4,verified:true,sourceUrl:F7_VW_DMX_WIDTHS}]}),
  {
  ...
  vw('desisti-super-led-f10-vw','Super LED F10 Vari-White','Super LED F10',200,250,2800,6600,250,F10_SRC,{ipRating:'IP22',dmxModes:[{name:'Vari-White',channels:3,verified:true,sourceUrl:F10_SRC,controls:[{key:'dimmer',label:'Dimmer',channel:1,type:'percent',min:0,max:100,dmxMin:0,dmxMax:255}]},{name:'Vari-White 16-bit',channels:4,verified:true,sourceUrl:F10_VW_DMX_MANUAL,controls:[{key:'dimmer',label:'Dimmer',channel:1,type:'percent',bits:16,min:0,max:100,dmxMin:0,dmxMax:65535}]}]}),
  {
  ...
  vw('desisti-super-led-f10hp-vw','Super LED F10 HP Vari-White','Super LED F10 HP',330,400,2800,6600,250,F10_SRC,{ipRating:'IP22',rainProtectedOption:'IP23',dmxModes:[{name:'Vari-White',channels:3,verified:true,sourceUrl:F10_SRC,controls:[{key:'dimmer',label:'Dimmer',channel:1,type:'percent',min:0,max:100,dmxMin:0,dmxMax:255}]},{name:'Vari-White 16-bit',channels:4,verified:true,sourceUrl:F10HP_VW_DMX_MANUAL,controls:[{key:'dimmer',label:'Dimmer',channel:1,type:'percent',bits:16,min:0,max:100,dmxMin:0,dmxMax:65535}]}]}),

  fixed('desisti-super-led-f10shp-t','Super LED F10 SHP T','Super LED F10 SHP',470,490,3200,96,96,250,F10_SHP_SRC,{ipRating:'IP20',rainProtectedOption:'IP23',beamAngleDeg:{min:15,max:78},control:['DMX512/RDM','On-board dimming'],dmxModes:[{name:'8-bit dimmer',channels:1,verified:true,sourceUrl:F10_SHP_SRC},{name:'16-bit dimmer',channels:2,verified:true,sourceUrl:F10_SHP_SRC}]}),
  fixed('desisti-super-led-f10shp-d','Super LED F10 SHP D','Super LED F10 SHP',470,490,5600,96,96,250,F10_SHP_SRC,{ipRating:'IP20',rainProtectedOption:'IP23',beamAngleDeg:{min:15,max:78},control:['DMX512/RDM','On-board dimming'],dmxModes:[{name:'8-bit dimmer',channels:1,verified:true,sourceUrl:F10_SHP_SRC},{name:'16-bit dimmer',channels:2,verified:true,sourceUrl:F10_SHP_SRC}]}),
  ...
  fixed('desisti-super-led-f14-t','Super LED F14 T','Super LED F14',400,null,3200,97,96,350,F14_SRC,{ipRating:'IP22',rainProtectedOption:'IP23',dmxModes:verifiedFixedDimmerWidths(F14_SRC)}),
