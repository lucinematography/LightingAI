...
const S2_VW_DMX='https://www.desisti.it/wp-content/uploads/2018/10/CE-Instruction-Manual-De-Sisti-SOFT-LED-2-VW.pdf';
...
const S8_VW_DMX='https://www.desisti.it/wp-content/uploads/2018/10/CE-Instruction-Manual-De-Sisti-SOFT-LED-8VW.pdf';
...
const S2XL_VW_DMX='https://www.desisti.it/wp-content/uploads/CE-Instruction-Manual-De-Sisti-SOFT-LED-2XL-VW.pdf';
...
const S8XL_VW_DMX='https://www.desisti.it/wp-content/uploads/CE-Instruction-Manual-De-Sisti-SOFT-LED-8XL-VW.pdf';
...
export const DESISTI_SOFTLED_FIXTURES=[
  ...
  vw('desisti-softled-2-vw','Soft LED 2 VW','Soft LED 2',120,null,S2,null,{dmxModes:[{name:'Vari-White',channels:3,verified:true,sourceUrl:S2,controls:[{key:'dimmer',label:'Dimmer',channel:1,type:'percent',min:0,max:100,dmxMin:0,dmxMax:255}]},{name:'Vari-White 16-bit',channels:4,verified:true,sourceUrl:S2_VW_DMX,controls:[{key:'dimmer',label:'Dimmer',channel:1,type:'percent',bits:16,min:0,max:100,dmxMin:0,dmxMax:65535}]}]}),
  ...
  vw('desisti-softled-4-vw','Soft LED 4 VW','Soft LED 4',180,205,S4,5.5,{dmxModes:[{name:'Vari-White',channels:3,verified:true,sourceUrl:S4_VW_DMX,controls:[{key:'dimmer',label:'Dimmer',channel:1,type:'percent',min:0,max:100,dmxMin:0,dmxMax:255}]},{name:'Vari-White 16-bit',channels:4,verified:true,sourceUrl:S4_VW_DMX,controls:[{key:'dimmer',label:'Dimmer',channel:1,type:'percent',bits:16,min:0,max:100,dmxMin:0,dmxMax:65535}]}]}),
  ...
  vw('desisti-softled-8-vw','Soft LED 8 VW','Soft LED 8',360,400,S8,11.0,{dmxModes:[{name:'Vari-White',channels:3,verified:true,sourceUrl:S8_VW_DMX,controls:[{key:'dimmer',label:'Dimmer',channel:1,type:'percent',min:0,max:100,dmxMin:0,dmxMax:255}]},{name:'Vari-White 16-bit',channels:4,verified:true,sourceUrl:S8_VW_DMX,controls:[{key:'dimmer',label:'Dimmer',channel:1,type:'percent',bits:16,min:0,max:100,dmxMin:0,dmxMax:65535}]}]}),

  vw('desisti-softled-1xl-vw','Soft LED 1 XL VW','Soft LED 1 XL',120,null,S1XL,null,{dmxModes:[{name:'Vari-White',channels:3,verified:true,sourceUrl:S1XL,controls:[{key:'dimmer',label:'Dimmer',channel:1,type:'percent',min:0,max:100,dmxMin:0,dmxMax:255}]},{name:'Vari-White 16-bit',channels:4,verified:true,sourceUrl:S1XL,controls:[{key:'dimmer',label:'Dimmer',channel:1,type:'percent',bits:16,min:0,max:100,dmxMin:0,dmxMax:65535}]}]}),
  ...
  vw('desisti-softled-8xl-vw','Soft LED 8 XL VW','Soft LED 8 XL',400,460,S8XL,19.8,{dmxModes:verifiedFixedModes(S8XL_VW_DMX)})
];
