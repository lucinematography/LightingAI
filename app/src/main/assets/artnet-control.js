...
function install(){
 ...
 E('artnetPatchDevice').addEventListener('change',choosePatch);
...
window.LightingAIArtNetControl={version:'0.2-dmx-patch',refreshPatch:renderPatchDevices};
