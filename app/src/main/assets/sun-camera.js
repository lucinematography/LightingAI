(function(){
  ...
  function init(){
    ...
    el('sunCameraHeading').addEventListener('input',update);el('sunCameraCompass').addEventListener('click',startCompass);el('sunCameraTimeline').addEventListener('click',jumpToTimeline);
