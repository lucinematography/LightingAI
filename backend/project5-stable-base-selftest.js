...
console.log(JSON.stringify({
  ...
  featureSurface: 'Project 5 catalog expansion: add verified De Sisti Spacelight and full accessory set without changing Planner layout or existing manufacturer data'
}, null, 2));
