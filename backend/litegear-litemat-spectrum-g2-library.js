...
export const LITEGEAR_LITEMAT_SPECTRUM_G2_FIXTURES=[
  ...
  fixture('litegear-litemat-spectrum-g2-2l','LiteMat Spectrum 2L (Gen 2)',100,55,2,3.4,'295.4 x 1016 x 25.4 mm',S2L,{
    modelNumber:'253-1',ledQuantity:2592,
    control:{
      fixtureNative:{
        local:false,dmx512:false,rdm:false,artNet:false,sacn:false,crmx:false,bluetooth:false,wifi:false,
        note:'LiteMat Spectrum 2L head is a 48V PDX light engine; manufacturer-documented external control is provided by a compatible LiteDimmer Spectrum.'
      },
      controller:{
        model:'LiteDimmer Spectrum AC/DC 200',
        connectionToFixture:'PDX power/data',
      ...
      unavailableDirectProtocols:[
        'No manufacturer-documented Bluetooth control path for LiteMat Spectrum 2L / LiteDimmer Spectrum AC/DC 200',
        'No manufacturer-documented Wi-Fi control path for LiteMat Spectrum 2L / LiteDimmer Spectrum AC/DC 200'
      ],
      dmx:{
        profileAppliesAt:'LiteDimmer Spectrum AC/DC 200 running Spectrum OS 3.1',
        officialProfileTable:SPECTRUM_OS3_DMX,
      ...
      sourceUrls:[S2L,DIMMER200,SPECTRUM_OS3_DMX]
    }
  }),
  fixture('litegear-litemat-spectrum-g2-3','LiteMat Spectrum 3 (Gen 2)',150,55,3,4.3,'536 x 775.7 x 25.4 mm',S3,{
    modelNumber:'254-1',ledQuantity:3888,
    control:{
      fixtureNative:{
        local:false,dmx512:false,rdm:false,artNet:false,sacn:false,crmx:false,bluetooth:false,wifi:false,
        note:'LiteMat Spectrum 3 head is a 48V PDX light engine; manufacturer-documented external control is provided by a compatible LiteDimmer Spectrum.'
      },
      controller:{
        model:'LiteDimmer Spectrum AC/DC 200',
        connectionToFixture:'PDX power/data',
      ...
      unavailableDirectProtocols:[
        'No manufacturer-documented Bluetooth control path for LiteMat Spectrum 3 / LiteDimmer Spectrum AC/DC 200',
        'No manufacturer-documented Wi-Fi control path for LiteMat Spectrum 3 / LiteDimmer Spectrum AC/DC 200'
      ],
      dmx:{
        profileAppliesAt:'LiteDimmer Spectrum AC/DC 200 running Spectrum OS 3.1',
        officialProfileTable:SPECTRUM_OS3_DMX,
      ...
      sourceUrls:[S3,DIMMER200,SPECTRUM_OS3_DMX]
    }
  }),
  fixture('litegear-litemat-spectrum-g2-4','LiteMat Spectrum 4 (Gen 2)',200,53,4,5.4,'536 x 1015.5 x 25.4 mm',S4,{
    modelNumber:'255-1',ledQuantity:5184,
    control:{
      fixtureNative:{
        local:false,dmx512:false,rdm:false,artNet:false,sacn:false,crmx:false,bluetooth:false,wifi:false,
        note:'LiteMat Spectrum 4 head is a 48V PDX light engine; manufacturer-documented external control is provided by a compatible LiteDimmer Spectrum.'
      },
      controller:{
        model:'LiteDimmer Spectrum AC/DC 200',
        connectionToFixture:'PDX power/data',
      ...
      unavailableDirectProtocols:[
        'No manufacturer-documented Bluetooth control path for LiteMat Spectrum 4 / LiteDimmer Spectrum AC/DC 200',
        'No manufacturer-documented Wi-Fi control path for LiteMat Spectrum 4 / LiteDimmer Spectrum AC/DC 200'
      ],
      dmx:{
        profileAppliesAt:'LiteDimmer Spectrum AC/DC 200 running Spectrum OS 3.1',
        officialProfileTable:SPECTRUM_OS3_DMX,
