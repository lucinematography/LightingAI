...
window.LightingAIArtNetControl={version:'0.8-master-rgb',refreshPatch:function(){renderPatchDevices();renderMasterControl();renderMasterCctControl();renderMasterRgbControl();},transport:controlTransport};
