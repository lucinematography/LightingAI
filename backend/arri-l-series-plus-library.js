...
export const ARRI_L_SERIES_PLUS_FIXTURES=[
 {id:'arri-l5-c-plus',manufacturer:'ARRI',model:'L5-C Plus',family:'L-Series Plus',category:'Light',sourceType:'RGBW LED Fresnel',lensDiameterIn:5,powerDrawW:135,ipRating:'IP20',control:{wired:['DMX-512A via adapter','RDM','Art-Net','sACN','Ethernet','SkyPanel Remote via USB-A'],wireless:['third-party receiver'],builtInWirelessDMX:false},variants:{housing:['blue/silver','black'],yoke:['manual','pole operated']},dmxModes:[{name:'Mode 1 CCT & RGBW 8 bit',channels:12,verified:true,sourceUrl:'https://www.arri.com/resource/blob/381308/ddc7ea24b1c45e4a9195cbf3a08326b0/arri-l-series-plus-dmx-protocol-data.pdf',controls:[{key:'dimmer',label:'Dimmer',channel:1,type:'percent',min:0,max:100,dmxMin:0,dmxMax:255},{key:'cct',label:'CCT',channel:2,type:'cct-linear',min:2800,max:10000,step:10,dmxMin:0,dmxMax:255},{key:'red',label:'Red',channel:5,type:'percent',min:0,max:100,dmxMin:0,dmxMax:255},{key:'green',label:'Green',channel:6,type:'percent',min:0,max:100,dmxMin:0,dmxMax:255},{key:'blue',label:'Blue',channel:7,type:'percent',min:0,max:100,dmxMin:0,dmxMax:255}]}],sourceUrl:SRC},
