...
// Canonical sources: official ARRI True Blue D-Series overview/brochure, lamps, ballasts, barndoors, filter frames, scrims and Daylight Sets.
...
const BALLAST='https://www.arri.com/en/lighting/daylight-tungsten/daylight/ballasts/max-range/L2.0014190';
...
export const ARRI_TRUE_BLUE_D12_ACCESSORIES=[
 ...
 {id:'arri-d12-eb-max-1-8',manufacturer:'ARRI',model:'EB MAX 1.8, ALF CCL DMX AutoScan',orderCode:'L2.0014190',category:'Ballast',compatibleWith:D12,sourceUrl:BALLAST},
 ...
 {id:'arri-d12-scrim-set',manufacturer:'ARRI',model:'Set of 4 Scrims 230 mm / 9.1 in',orderCode:'L2.79860.0',category:'Scrim',compatibleWith:D12,sourceUrl:SCRIMS},
 {id:'arri-d12-scrim-full-single',manufacturer:'ARRI',model:'Scrim Full Single 230 mm / 9.1 in',orderCode:'L2.79860.A',category:'Scrim',compatibleWith:D12,sourceUrl:SCRIMS},
 {id:'arri-d12-scrim-full-double',manufacturer:'ARRI',model:'Scrim Full Double 230 mm / 9.1 in',orderCode:'L2.79860.B',category:'Scrim',compatibleWith:D12,sourceUrl:SCRIMS},
 {id:'arri-d12-scrim-half-double',manufacturer:'ARRI',model:'Scrim Half Double 230 mm / 9.1 in',orderCode:'L2.79860.D',category:'Scrim',compatibleWith:D12,sourceUrl:SCRIMS},
 {id:'arri-d12-scrim-bag',manufacturer:'ARRI',model:'Scrim Bag for 230 mm / 9.1 in scrims',orderCode:'L2.88914.1',category:'Bag',compatibleWith:D12,sourceUrl:SCRIMS},
