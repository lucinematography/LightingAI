...
export const EVLIGHT_PROFILE_FIXTURES=[
  ...
  fixture('evlight-epro400fc','EPRO400FC',{
    ...
    control:{
      ...
      externalInterfaceRequired:[],
      unavailableDirectProtocols:[
        'Official EV Light public product information does not publish a verified DMX512/RDM control route for EPRO400FC',
        'No manufacturer-documented Art-Net or sACN network input is published for EPRO400FC',
        'No manufacturer-documented CRMX/LumenRadio, Bluetooth or Wi-Fi control path is published for EPRO400FC'
      ],
      sourceUrls:[STUDIO]
    },
