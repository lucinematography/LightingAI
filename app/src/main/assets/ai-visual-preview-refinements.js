...
function install(){
 ...
 var hint=document.createElement('div');hint.style.cssText='margin:5px 0 9px;color:#9299a3;font-size:11px;line-height:1.4';hint.textContent=isSr()?'Svaka korekcija pravi novu verziju od početne fotografije. Ako želiš više promena zajedno, upiši ih sve u polje ispod i pritisni NAPRAVI MOJU VERZIJU.':'Each refinement creates a new version from the original photo. To combine changes, enter all of them below and tap CREATE MY VERSION.';box.appendChild(hint);
