...
function renderDiagnostics(nativePayload,error){
 ...
 box.innerHTML=rowsHtml+nativeHtml+'<div class="muted small" style="margin-top:8px">'+esc(t().diagNoAck)+'</div>';
}
