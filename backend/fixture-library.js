export const FIXTURE_LIBRARY = [
  ...
  },
  {
    ...
    beamAngleDeg: 55,
    mount: 'Bowens',
    control: ['On-board', 'Sidus Link', 'DMX512', '2.4GHz'],
    acInput: '100-240V AC, 50/60Hz',
    batterySupport: '12-16.8V, 15A',
    weightKg: 3.2,
  ...
  },
  {
    ...
    control: ['On-board', 'Sidus Link', '2.4GHz'],
    acInput: '100-240V AC, 50/60Hz',
    batterySupport: 'Dual 14.4V/26V/28.8V batteries or 48V XLR',
    weatherproofing: false,
    lumens: 62187,
    flickerFreeFps: 2000,
    sourceUrl: 'https://aputure.com/en-US/products/ls-600d'
  },
  {
  ...
  },
  {
    ...
    mount: 'Bowens',
    dimming: { minPercent: 0, maxPercent: 100 },
    control: ['On-board', 'Sidus Link', 'DMX/RDM', 'CRMX', 'Art-Net', 'sACN', 'etherCON'],
    acInput: '100-240V AC, 50/60Hz',
    batterySupport: '14.4V/26V/28.8V batteries or 48V XLR',
    ipRating: 'IP54',
    weightKg: 5.9,
