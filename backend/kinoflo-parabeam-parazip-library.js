...
function fixture(id,model,family,sourceUrl){
  return {
...
export const KINOFLO_PARABEAM_PARAZIP_FIXTURES=[
  ...
  fixture('kinoflo-parazip-200-dmx','ParaZip 200 DMX','ParaZip',PZ200),
  fixture('kinoflo-parazip-215-dmx','ParaZip 215 DMX','ParaZip',PZ215),
  fixture('kinoflo-parazip-400-dmx','ParaZip 400 DMX','ParaZip',PZ400),
  fixture('kinoflo-parazip-415-dmx','ParaZip 415 DMX','ParaZip',PZ415)
];
